...
<?php } else { ?>
	<div id="contenedor_denuncia">
		<p class="letra_grande">
			Por favor escriba su denuncia y bríndenos datos si los tiene. Recuerde que la información que entregue se mantendrán en absoluta reserva.
		</p>
		<textarea id="denuncia" class="form-control" rows="5" autofocus></textarea><br>

		<button id="denunciar" type="button" class="btn btn-primary btn-lg btn-block">Enviar denuncia</button>
	</div>
<?php } ?>
